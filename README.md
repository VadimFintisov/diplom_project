...
2. Монтирование виртуальной файловой системы FUSE и запуск скрипта на исполнение интерпретатором Python. Проверка системного журнала. Чтобы примонтировать виртуальную файловую систему FUSE, необходимо выбрать ранее созданную точку монтирования, которая должна быть пустой, и выполнить команду:

/# `./fusexmp /home/mnt/fuse -o allow_other`
